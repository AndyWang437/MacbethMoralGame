...
export const CriticalAnalysisModal: React.FC<CriticalAnalysisModalProps> = ({ scene, onClose }) => {
  return (
      ...
      <div className="bg-macbeth-dark text-white p-8 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  {scene.criticalLens?.themes?.map((theme: Theme, index: number) => (
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  {scene.criticalLens?.symbolism?.map((symbol: Symbol, index: number) => (
                    <li key={index} className="text-macbeth-light">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-macbeth-light">{scene.criticalLens?.historicalContext?.jacobean}</p>
              </div>
              
              <div>
                <h4 className="font-bold text-macbeth-gold">Shakespeare's Sources</h4>
                <p className="text-macbeth-light">{scene.criticalLens?.historicalContext?.sources}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              {scene.criticalLens?.criticQuotes.map((quote, index) => (
          ...
          <section>
            ...
            <div className="space-y-4">
              {scene.criticalLens?.adaptations.map((adaptation, index) => (
